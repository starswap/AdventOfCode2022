...
object Day5 { // acts as a namespace
    abstract class Base(lines: List<String>) {
    ...
    class Part1(lines: List<String>) : Base(lines) {
    ...
    class Part2(lines: List<String>) : Base(lines) {
        override fun moveCrates(instruction: Instruction) {
            val (numCrates, from, to) = instruction;
...
fun main() {
    ...
    val part1 = Day5.Part1(lines)
    println("Part 1 ans: ${part1.run()}")

    val part2 = Day5.Part2(lines)
