...
fun score(thisTurn: Pair<Int, Int>): Int {
...
fun transformRd2(thisTurn: Pair<Int,Int>): Pair<Int, Int> {
...
fun main() {
    ...
    println("Part 1 answer ${part1(turns)}")
    println("Part 2 answer ${part2(turns)}")
